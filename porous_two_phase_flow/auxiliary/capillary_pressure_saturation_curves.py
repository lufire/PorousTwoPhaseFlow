...
settings_path = (r'/home/lukas/PycharmProjects/PorousTwoPhaseFlow/data/saturation_model_settings.json')
...
saturation_models = \
    {key: SaturationModel(settings['saturation_model'][key], porous_layer,
                          fluid)
     for key in settings['saturation_model']
     if key not in ('type', 'PSD')}
